...
#         if fine_tune:
#             model_name = 'ft_pgn'
        if scheduled_sampling and fine_tune:
            model_name = 'ft_ss_pgn'
        else:
            model_name = 'cov_pgn'
    elif scheduled_sampling:
        model_name = 'ss_pgn'
    elif weight_tying:
        model_name = 'wt_2way_pgn'
    else:
...
log_path_loss = '../runs/' + model_name + '/loss'
log_path_val_loss = '../runs/' + model_name + '/val_loss'
log_path_grad = '../runs/' + model_name + '/grad'
